...
# ondeck added
declare -r ssl_opts="-Djavax.net.ssl.trustStore=./.keystore -Djavax.net.ssl.trustStorePassword=changeit"
declare -r default_jvm_opts_common="-Xms512m -Xmx1536m -Xss2m $jit_opts $cms_opts $ssl_opts"
